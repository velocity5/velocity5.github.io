...
if ( has_nav_menu( 'secondary' ) ) : // Check if there's a menu assigned to the 'secondary' location.
	...
	?>
	<div class="screen-reader-text"><?php _e( 'Secondary Navigation Menu', 'metrolo' ); ?></div>
	<nav <?php hybridextend_attr( 'menu', 'secondary' ); ?>>
		<div class="menu-toggle"><span class="menu-toggle-text"><?php _e( 'Menu', 'metrolo' ); ?></span><i class="fas fa-bars"></i></div>
