...
if (!function_exists('savana_lite_default_format_function')) {

	function savana_lite_default_format_function() {
	...
	add_action( 'savana_lite_default_format', 'savana_lite_default_format_function' );
